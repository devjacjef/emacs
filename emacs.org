...
** Language Modes
   ...
   Making sure languages I want to use are installed.
   
*** Web

    This mode provides the ability to work with web templates effectively.
...
*** References
    ...
    - [[https://github.com/emacs-lsp/lsp-mode/issues/3577][Eager macro-expansion failure in lsp-terraform.el]]
    - [[https://www.reddit.com/r/emacs/comments/rk5eol/anyone_got_a_lsp_setup_with_php/][anyone got a lsp setup with php? | u/Winter-Country]]
...
*** Source
    ...
    ;; Making web-mode and lsp-mode play nice...
...
*** References
    ...
    - [[http://xahlee.info/emacs/emacs/emacs_new_empty_buffer.html][Emacs: New Empty Buffer 📜 | Xah Lee]]
    - [[https://github.com/akermu/emacs-libvterm/issues/24#issuecomment-438048042][Close buffer and (optional) window when a vterm process is finished.]]
...
*** Source
    ...
    (use-package general
      ...
      (general-create-definer devjj/keybinds
...
** References
   ...
   - [[https://hugocisneros.com/org-config/#general-style][Org-mode configuration | Hugo Cisneros]]
...
** Source
   ...
   (set-face-attribute 'org-document-title nil :font "JetBrains Mono" :weight
         		    'bold :height 1.8)
      		...
      		(:eval (propertize
      			...
      			`((space :align-to
      				 (-  (+ right right-fringe right-margin)
      					 ...
      					 (string-width "%4l:3%c")
   					 (string-width (format-mode-line global-mode-string))))))))
...
** TODO Find more keybinds for this.
   ...
   (devjj/keybinds
     ...
     "ot" '(vterm-new :which-key "Open Vterm"))
